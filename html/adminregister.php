...
<h1 class="fas fa-close" id="close"></h1>
    ...
    <!-- Register Section -->
    <section class="form-sect" id="reg-el">
  <div class="form-box nav-top">
    <h3 class="">Register</h3>
    <p class="p">Thanks for creating an account with us</p>
    <form action="../html/registersub.php" method="POST" enctype="multipart/form-data">
      <input class="w3-input " type="text" placeholder="fullname" required name="fullname"><br>
  ...
  <p class="p2">Already Have An Account? <a href="../html/adminlogin.php" id="login-el" onclick="switche2();">Login</a></p>
  </div>
</section>

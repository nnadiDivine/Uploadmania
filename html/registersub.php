<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($fullname == "" || $email == "" || $password == "" || $conpassword == "") {
           ...
           header("location: ../html/adminregister.php?error=".$error);
           return false;
        }else {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            return false;
                ...
                $sql = "INSERT INTO admin(fullname, email, password) VALUES('$fullname', '$email', '$new_pass')";
                $result = mysqli_query($connect, $sql);
                if ($result) {
                    $success = urlencode("registration sucessful");
                    header("location: ../html/adminlogin.php?success=".$success);
                    return false;
                }else{

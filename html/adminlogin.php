...
<h1 class="fas fa-close" id="close"></h1>
    ...
    <section class="form-sect2" id="log-el">
      <div class="form-box nav-top">
        ...
        <form action="../html/loginsub.php" method="POST">
          ...
          <div class="form-group">
                ...
                <div class="text-center marg">
					<a href="#" data-toggle="modal" data-target="#myModal" id="modalBtn">Forgot Password?</a>
				</div>
          <button class="" type="submit" name="submit">Login</button>
        </form>
      <p class="p2">Dont Have An Account? <a href="../html/adminregister.php" id="login-el" onclick="switche();">Register</a></p>
      </div>
    </section>
    </form>
    ...
    <div id="simpleModal" class="modal">
                    ...
                    <form action="../html/reset.php" method="POST" class="Signup-form">
					...
					<input type="hidden" name="id" value="<?php echo $id ?>">
                        ...
                        <button name="reset" class="form-btn mt-3">Change</button>
                    </div>
                    </form>
                    </div>
                </div>

...
<body>
    <section class="nav">
    <aside>
        <a href="../html/indexe.php"><div class="logo">
...
<h1 class="fas fa-close" id="close"></h1>
        ...
        <nav class="nav-sect" id="nav">
            <div class="nav-links">
                ...
                <div class="nav-main">
                <a href="usersdashboard.php" class=""><img src="../uploads/<?= $img ?>" style="width: 50px; height: 50px; border-radius: 50px;" alt=""></a>
                </div>
            </div>
            <!-- jh -->
            </div>
    ...
    <form action="../html/usersmessagee.php" method="POST" enctype="multipart/form-data">
      ...
      <button class="" type="submit" name="submit">Message</button>
    </form>
  </div>
    </section>
</body>

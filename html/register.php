...
<h1 class="fas fa-close" id="close"></h1>
  ...
  <div class="form-box nav-top">
    ...
    <form action="../html/registersup.php" method="POST" enctype="multipart/form-data">
  ...
  <p class="p2">Already Have An Account? <a href="../html/login.php" id="login-el" onclick="switche2();">Login</a></p>
  </div>
</section>

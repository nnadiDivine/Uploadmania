        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if (mysqli_num_rows($check_result) == 1) {
                ...
                $mailcontent = '
                    ...
                    <p>we got a request to reset your password, if this was you, click the link <b><i><a href="https://www.vine.cum/html/passwordresete.php?email='.$email.'"></a>Password Reset</a></i></b> to rest password or ignore and nothing will happen to your account </p>
                    </div>
                </div>
                ';
                ...
                if ($sent) {
                    ...
                    header("location: ../html/adminlogin.php?sucess=".$sucess);
                    return false;
                }else {
